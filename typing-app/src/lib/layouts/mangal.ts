...
// Mangal (Unicode) uses the Remington Gail key mapping by default for
// government typing practice. Physical keys map to Devanagari Unicode.
export const mangalLayout: KeyboardLayout = {
  id: 'mangal',
  name: 'Mangal Unicode',
  language: 'hindi',
  hindiMode: 'mangal',
